...
def train(args):
    # define dataLoader
    # args.batch_size = 1
    base_path = './vis_result/unet+nc_cta'
...
if __name__ == "__main__":
    ...
    # else:
    args.resume = '/root/workspace/zhangzeao/Attenuation-Correction/zhangzeao/AC_final/checkpoints/unet3D/best_checkpoint_model.pth'
