...
def train(args, run):
    ...
    for iter_num in pbar:
        ...
        run.log({"mse_st": scores["mse"], "pnsr_st": scores["pnsr"], "ssim_st": scores["ssim"]}, step=iter_num)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='/root/workspace/zhangzeao/Attenuation-Correction/zhangzeao/AC_final/checkpoints/Unet3D')
